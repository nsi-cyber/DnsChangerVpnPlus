        ...
        ms3.setVisibility(View.INVISIBLE);
         ...
         receiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                long[] s = intent.getLongArrayExtra("data");
               ping1=s[0];
                ping2=s[1];
                ping3=s[2];
            }
    ...
    public void onClick(View view) {
        ...
        msTest.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(com.example.dnschangervpnt.MainActivity.this,LookUpService.class);
                ...
                updateUIReciver = new BroadcastReceiver() {
                    ...
                    public void onReceive(Context context, Intent intent) {
                        long[] s = intent.getLongArrayExtra("data");
                        ms1.setText(": "+(int) s[0]+" ms");
                        ms2.setText(": "+(int) s[1]+" ms");
                        ms3.setText(": "+(int) s[2]+" ms");
ping1=(int)s[0];
                        ping2=(int)s[1];
                        ping3=(int)s[2];
                ...
                Double a1 = Double.valueOf(ping1);
                Double a2 = Double.valueOf(ping2);
                Double a3 = Double.valueOf(ping3);
...
public void devIpAd() throws SocketException {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data, String deviceIp, String DnsLink, String Dns2Link, boolean v6, boolean disconnect) {
        ...
        if (resultCode == RESULT_OK) {
            Intent intent = new Intent(this, com.example.dnschangervpnt.MyVpnService.class);
